...
ansible-playbook -i ansible-files/rancher-hosts ansible-files/install-deps-aliyun-worker.yml
ansible-playbook -i ansible-files/rancher-hosts ansible-files/install-rancher-aliyun-worker.yml
